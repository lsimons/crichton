...
# define a new temporary package_obj, saving the [package_name,version] data
# (we need to call it package_obj since package already exists)
class Migration(SchemaMigration):

    def forwards(self, orm):
        
        # Adding field 'ReleaseElement.package_obj'
        db.add_column('release_releaseelement', 'package_obj', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['package.Package'], null=True, blank=True), keep_default=False)

        # Adding field 'ReleaseElementAuditLogEntry.package_obj'
        db.add_column('release_releaseelementauditlogentry', 'package_obj', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['package.Package'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReleaseElement.package_obj'
        db.delete_column('release_releaseelement', 'package_obj_id')

        # Deleting field 'ReleaseElementAuditLogEntry.package_obj'
        db.delete_column('release_releaseelementauditlogentry', 'package_obj_id')
