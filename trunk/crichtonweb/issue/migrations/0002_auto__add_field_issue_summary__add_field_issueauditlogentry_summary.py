...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Issue.summary'
        db.add_column('issue_issue', 'summary', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'IssueAuditLogEntry.summary'
        db.add_column('issue_issueauditlogentry', 'summary', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.summary'
        db.delete_column('issue_issue', 'summary')

        # Deleting field 'IssueAuditLogEntry.summary'
        db.delete_column('issue_issueauditlogentry', 'summary')
