...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NodeAddressAuditLogEntry'
        db.create_table('system_nodeaddressauditlogentry', (
            ('id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_auditlog_addresses', to=orm['system.Node'])),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_auditlog_nodes', to=orm['system.InternetAddress'])),
            ...
            ('action_user', self.gf('audit_log.models.fields.LastUserField')(related_name='_nodeaddress_audit_log_entry')),
            ('action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('system', ['NodeAddressAuditLogEntry'])

        # Adding model 'NodeAddress'
        db.create_table('system_nodeaddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(related_name='addresses', to=orm['system.Node'])),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(related_name='nodes', to=orm['system.InternetAddress'])),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('system', ['NodeAddress'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NodeAddressAuditLogEntry'
        db.delete_table('system_nodeaddressauditlogentry')

        # Deleting model 'NodeAddress'
        db.delete_table('system_nodeaddress')
