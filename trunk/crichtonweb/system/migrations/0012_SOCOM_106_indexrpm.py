...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'crichtonStatus.last_indexrpm_success'
        db.add_column('system_crichtonstatus', 'last_indexrpm_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'crichtonStatus.last_indexrpm_success'
        db.delete_column('system_crichtonstatus', 'last_indexrpm_success')
