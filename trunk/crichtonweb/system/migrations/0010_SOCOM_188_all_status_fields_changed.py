...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'crichtonStatus.last_hudson_fetch_ok'
        db.delete_column('system_crichtonstatus', 'last_hudson_fetch_ok')

        # Deleting field 'crichtonStatus.last_puppet_fetch_ok'
        db.delete_column('system_crichtonstatus', 'last_puppet_fetch_ok')

        # Deleting field 'crichtonStatus.last_cron_end'
        db.delete_column('system_crichtonstatus', 'last_cron_end')

        # Deleting field 'crichtonStatus.last_cron_start'
        db.delete_column('system_crichtonstatus', 'last_cron_start')

        # Adding field 'crichtonStatus.last_indexjira_success'
        db.add_column('system_crichtonstatus', 'last_indexjira_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)

        # Adding field 'crichtonStatus.last_indexhudson_success'
        db.add_column('system_crichtonstatus', 'last_indexhudson_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)

        # Adding field 'crichtonStatus.last_indexrepo_success'
        db.add_column('system_crichtonstatus', 'last_indexrepo_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)

        # Adding field 'crichtonStatus.last_indexzenoss_success'
        db.add_column('system_crichtonstatus', 'last_indexzenoss_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'crichtonStatus.last_hudson_fetch_ok'
        db.add_column('system_crichtonstatus', 'last_hudson_fetch_ok', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'crichtonStatus.last_puppet_fetch_ok'
        db.add_column('system_crichtonstatus', 'last_puppet_fetch_ok', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'crichtonStatus.last_cron_end'
        db.add_column('system_crichtonstatus', 'last_cron_end', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)

        # Adding field 'crichtonStatus.last_cron_start'
        db.add_column('system_crichtonstatus', 'last_cron_start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)

        # Deleting field 'crichtonStatus.last_indexjira_success'
        db.delete_column('system_crichtonstatus', 'last_indexjira_success')

        # Deleting field 'crichtonStatus.last_indexhudson_success'
        db.delete_column('system_crichtonstatus', 'last_indexhudson_success')

        # Deleting field 'crichtonStatus.last_indexrepo_success'
        db.delete_column('system_crichtonstatus', 'last_indexrepo_success')

        # Deleting field 'crichtonStatus.last_indexzenoss_success'
        db.delete_column('system_crichtonstatus', 'last_indexzenoss_success')
