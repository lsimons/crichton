...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('release_release', 'release_number', 'release_order')
        db.rename_column('release_releaseauditlogentry', 'release_number', 'release_order')


    def backwards(self, orm):
        db.rename_column('release_release', 'release_order', 'release_number')
        db.rename_column('release_releaseauditlogentry', 'release_order', 'release_number')
