...
# delete the old [package_name, version] data
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ReleaseElement.package_version'
        db.delete_column('release_releaseelement', 'package_version_id')

        # Deleting field 'ReleaseElementAuditLogEntry.package_version'
        db.delete_column('release_releaseelementauditlogentry', 'package_version_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('release_releaseelement', 'package', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['package.PackageName']), keep_default=False)

        # Adding field 'ReleaseElement.package_version'
        db.add_column('release_releaseelement', 'package_version', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['package.Version']), keep_default=False)
        ...
        # Adding field 'ReleaseElementAuditLogEntry.package_version'
        db.add_column('release_releaseelementauditlogentry', 'package_version', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['package.Version']), keep_default=False)

        # Adding field 'ReleaseElementAuditLogEntry.package'
        db.add_column('release_releaseelementauditlogentry', 'package', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['package.PackageName']), keep_default=False)
