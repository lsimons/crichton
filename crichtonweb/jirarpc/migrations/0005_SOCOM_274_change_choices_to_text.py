...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomFieldAuditLogEntry.choices'
        db.alter_column('jirarpc_customfieldauditlogentry', 'choices', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CustomFieldAuditLogEntry.helptext'
        db.alter_column('jirarpc_customfieldauditlogentry', 'helptext', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CustomField.helptext'
        db.alter_column('jirarpc_customfield', 'helptext', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CustomField.choices'
        db.alter_column('jirarpc_customfield', 'choices', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'CustomFieldAuditLogEntry.choices'
        db.alter_column('jirarpc_customfieldauditlogentry', 'choices', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'CustomFieldAuditLogEntry.helptext'
        db.alter_column('jirarpc_customfieldauditlogentry', 'helptext', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'CustomField.helptext'
        db.alter_column('jirarpc_customfield', 'helptext', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'CustomField.choices'
        db.alter_column('jirarpc_customfield', 'choices', self.gf('django.db.models.fields.CharField')(max_length=1024))
