...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'NodeAddress', fields ['node', 'address']
        db.create_unique('system_nodeaddress', ['node_id', 'address_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'NodeAddress', fields ['node', 'address']
        db.delete_unique('system_nodeaddress', ['node_id', 'address_id'])
