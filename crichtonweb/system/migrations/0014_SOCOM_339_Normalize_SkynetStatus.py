...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'crichtonCronJobStatus'
        db.create_table('system_crichtoncronjobstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('system', ['crichtonCronJobStatus'])
    ...
    def backwards(self, orm):
        ...
        db.create_table('system_crichtonstatus', (
            ('last_indexrpm_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0))),
            ('last_indexzenoss_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0))),
            ('last_indexrepo_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0))),
            ('last_indexhudson_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0))),
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('last_indexjira_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0))),
        ))
        db.send_create_signal('system', ['crichtonStatus'])

        # Deleting model 'crichtonCronJobStatus'
        db.delete_table('system_crichtoncronjobstatus')
    ...
    models = {
        ...
        'system.crichtoncronjobstatus': {
            'Meta': {'ordering': "('name',)", 'object_name': 'crichtonCronJobStatus'},
