...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('system_packageinstallation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('package', self.gf('django.db.models.fields.related.ForeignKey')(related_name='installations', to=orm['package.Package'])),
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(related_name='package_installations', to=orm['system.Node'])),
            ('first_seen', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('not_seen', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
        ))
        db.send_create_signal('system', ['PackageInstallation'])

        # Adding unique constraint on 'PackageInstallation', fields ['node', 'package', 'not_seen']
        db.create_unique('system_packageinstallation', ['node_id', 'package_id', 'not_seen'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PackageInstallation', fields ['node', 'package', 'not_seen']
        db.delete_unique('system_packageinstallation', ['node_id', 'package_id', 'not_seen'])

        # Deleting model 'PackageInstallation'
        db.delete_table('system_packageinstallation')
