...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pool.role'
        db.add_column('system_pool', 'role', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pools', to=orm['system.Role']), keep_default=False)

        # Adding field 'PoolAuditLogEntry.role'
        db.add_column('system_poolauditlogentry', 'role', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='_auditlog_pools', to=orm['system.Role']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pool.role'
        db.delete_column('system_pool', 'role_id')

        # Deleting field 'PoolAuditLogEntry.role'
        db.delete_column('system_poolauditlogentry', 'role_id')
